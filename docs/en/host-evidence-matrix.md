...
|---|---|---|---|
| **Containment gate** (`Test-Containment.ps1`) | **PASS** — verified on Windows PowerShell 5.1 and PowerShell 7 | UNVERIFIED | UNVERIFIED |
...
| **Cross-platform install path** (`install.sh`) | N/A (use the Windows launcher) | UNVERIFIED — intended path, not yet measured | UNVERIFIED — intended path, not yet measured |
