...
| **Merged PRs** | 113 | grows — see [merged PRs](https://github.com/mizan0515/driftless/pulls?q=is%3Apr+is%3Amerged) |
...
| **Agent skills** | 73 (39 Claude + 34 Codex) | the 6 shared + 2 tool-specific shipped here, mirror-parity-gated |
