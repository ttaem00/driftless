...
- `breakthrough-opportunity-review/` — public-safe Big Shift / breakthrough-opportunity review: lock scope, inspect current repo/ticket/session evidence plus public sources, run a multi-layer opportunity sweep, route implementation through tickets/parallel lanes when requested, and use transfer-learning concepts to preserve reusable lessons.
